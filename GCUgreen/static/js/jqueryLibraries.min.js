 ...
 * ge Media Width
 **/
function ge_media_width() {
    var media_width = parseInt(jQuery('.ge_responsive_width').css('width'));
...
(function (e, t, n) {
    ...
    if (!t.requestAnimationFrame)t.requestAnimationFrame = function (e, n) {
        var i = (new Date).getTime(), s = i - r, o = Math.max(0, 16 - s);
...
!function (a) {
    ...
    !function (a) {
        ...
        var b = "absolute";
        if ("body" == this.parent.element.tagName.toLowerCase())b = "fixed"; else {
        ...
        if (this.options = a.extend({}, this.defaultOptions, this.options), this.findImageInElement(this.element), 1 == this.options.deepSearch)for (var b = this.$element.find("*:not(script)"), c = 0; c < b.length; c++)this.findImageInElement(b[c]);
        this.preloadContainer.create(), this.overlayLoader.createOverlay()
    }, e.prototype.findImageInElement = function (b) {
        var c = "", e = a(b), f = "normal";
        if ("none" != e.css("background-image") ? (c = e.css("background-image"), f = "background") : "undefined" != typeof e.attr("src") && "img" == b.nodeName.toLowerCase() && (c = e.attr("src")), !this.hasGradient(c)) {
            c = this.stripUrl(c);
            for (var g = c.split(", "), h = 0; h < g.length; h++)if (this.validUrl(g[h]) && this.urlIsNew(g[h])) {
                var i = "";
                if (this.isIE() || this.isOpera())i = "?rand=" + Math.random(), this.preloadContainer.addImage(g[h] + i); else if ("background" == f)this.preloadContainer.addImage(g[h] + i); else {
                    var j = new d(this);
        ...
        if (this.options.onLoadComplete(), "grow" == this.options.completeAnimation) {
            ...
            this.overlayLoader.loadbar[0].parent = this, this.overlayLoader.loadbar.stop().animate({width: "100%"}, b, function () {
                a(this).animate({top: "0%", width: "100%", height: "100%"}, 500, function () {
    ...
    e.fn.extend({
        scrollspy: function (n) {
            ...
            return this.each(function (t) {
                ...
                var o = i.mode;
                var u = i.buffer;
                var leaves = 0, a = leaves;
                var f = false;
                s.bind("scroll", function (t) {
                    var n = {top: e(this).scrollTop(), left: e(this).scrollLeft()};
                    var l = o == "vertical" ? n.top + u : n.left + u;
                    var c = i.max;
                    var h = i.min;
                    if (e.isFunction(i.max)) {
                        c = i.max()
                    }
                    if (e.isFunction(i.min)) {
                        h = i.min()
                    }
                    if (c == 0) {
                        c = o == "vertical" ? s.height() : s.outerWidth() + e(r).outerWidth()
                    }
                    if (l >= h && l <= c) {
                        if (!f) {
                            f = true;
                            a++;
                            e(r).trigger("scrollEnter", {position: n});
                            if (e.isFunction(i.onEnter)) {
                                i.onEnter(r, n)
                            }
                        }
                        e(r).trigger("scrollTick", {position: n, inside: f, enters: a, leaves: leaves});
                        if (e.isFunction(i.onTick)) {
                            i.onTick(r, n, f, a, leaves)
                        }
                    } else {
                        if (f) {
                            f = false;
                            leaves++;
                            e(r).trigger("scrollLeave", {position: n, leaves: leaves});
                            if (e.isFunction(i.onLeave)) {
                                i.onLeave(r, n)
                            }
                        }
                    }
...
//e.v.newMidHeight = e.v.midHeight / 1.4   98/1.4=70 1593行 zhaojiande
...
!function (s) {
    "use strict";
    s.fn.geResponsiveNav = function (n) {
        var t = {submenu: "ul.sub-menu", respButton: ".responsive_nav", startWidth: 1024}, e = this, i = {};
        i = {
            init: function () {
                ...
                i.v.trigger = !0, i.v.counter = 1, i.v.subLink.each(function () {
                    "" === s(this).text() && (i.v.pLinkText = s(this).closest("ul").closest("li").find("> a").text(), s(this).addClass("ge_resp_nav_custom_text").html('<span class="nav_item_wrap"><span class="nav_title">' + i.v.counter + '. ' + i.v.pLinkText + '</span></span>'), i.v.counter += 1), s(this).append('<span class="ge_resp_nav_toggle ge_theme_icon_resp_nav_slide_down" />')
                }), i.v.subLinkToggle = i.v.subLink.find("> span.ge_resp_nav_toggle"), i.v.submenu.hide(), i.attachEvents()
            }, restartNav: function () {
                !i.v.trigger && ge_media_width() <= i.v.startWidth ? i.buildNav() : i.v.trigger && ge_media_width() > i.v.startWidth && i.destroyNav()
            }, resetNav: function () {
                i.v.subLinkToggle.removeClass("ge_theme_icon_resp_nav_slide_up").addClass("ge_theme_icon_resp_nav_slide_down"), i.v.submenu.hide()
            }, destroyNav: function () {
                i.v.subLink.each(function () {
                    s(this).hasClass("ge_resp_nav_custom_text") && s(this).removeClass("ge_resp_nav_custom_text").text(""), s(this).find("span.ge_resp_nav_toggle").remove()
                ...
                i.v.subLinkToggle.on("click", function () {
                    return s(this).hasClass("ge_theme_icon_resp_nav_slide_up") ? (s(this).removeClass("ge_theme_icon_resp_nav_slide_up").addClass("ge_theme_icon_resp_nav_slide_down").closest("li").find("ul.sub-menu").hide(), s(this).closest("li").find("span.ge_resp_nav_toggle").removeClass("ge_theme_icon_resp_nav_slide_up").addClass("ge_theme_icon_resp_nav_slide_down")) : s(this).removeClass("ge_theme_icon_resp_nav_slide_down").addClass("ge_theme_icon_resp_nav_slide_up").closest("li").find("ul.sub-menu").eq(0).show(), !1
...
(function (e, t, n) {
    ...
    var r = {
        init: function (t, n) {
            ...
            var e = this, i = "translate3d(0px, 0px, 0px)", s = n.createElement("div"), o, u, a, f;
            ...
            e.browser = {support3d: r.isPerspective() !== false ? true : false, isTouch: f}
        }, isStyleSupported: function (e) {
            var t, n, r = document.createElement("div"), i = e;
            for (t in i) {
                n = i[t];
            ...
            function s(n) {
                var s = n.originalEvent || n || t.event, o;
                if (s.which === 3) {
                    return false
                }
            ...
            function o(i) {
                var s = i.originalEvent || i || t.event, o, u;
            ...
            function u(n) {
                var r = n.originalEvent || n || t.event, s, o, u;
                if (!r.target) {
            ...
            function n() {
                var n = e(i.$owlItems[i.currentItem]).height(), r = i.currentItem, s = i.itemsAmount - i.maximumItem;
            ...
            var t = this, n = t.outClass, r = t.inClass, i = t.$owlItems.eq(t.currentItem), s = t.$owlItems.eq(t.prevItem), o = Math.abs(t.positionsInArray[t.currentItem]) + t.positionsInArray[t.prevItem], u = Math.abs(t.positionsInArray[t.currentItem]) + t.itemWidth / 2, a = "webkitAnimationEnd oAnimationEnd MSAnimationEnd animationend";
            t.isTransition = true;
...
(function (e) {
    "use strict";
    e.fn.geHoverSlider = function (t) {
        var n = {
            sliderBlock: ".ge_hover_slider",
            sliderItems: ".ge_hover_slider_items",
            thumbWidth: "60",
            thumbHeight: "40",
            activeSlide: 1,
            pauseTime: 5e3,
        ...
        o = {
            init: function () {
                ...
                o.vars.sliderBlock.append('<ul class="ge_hover_slider_thumbs"></ul>');
                for (var i = 0; i < o.vars.items_img_count; i += 1) {
                    o.vars.thumbsHTML += "<li>" + '<a href="#" class="ge_hover_slider_thumb">' + '<img src="' + o.vars.items_img.eq(i).attr("src") + '" alt="" width="' + o.vars.items_thumbWidth + '" height="' + o.vars.items_thumbHeight + '" />' + "</a>" + "</li>"
                }
                o.vars.sliderBlock.find(".ge_hover_slider_thumbs").append(o.vars.thumbsHTML);
                o.vars.items.eq(o.vars.activeSlide).css({visibility: "visible", opacity: 1}).addClass("hovered_slide");
                o.vars.sliderBlock.find(".ge_hover_slider_thumbs > li").eq(o.vars.activeSlide).addClass("hovered_item");
                o.vars.activeSlide += 1;
                o.attachEvents()
            }, nextSlide: function (e) {
                o.setTimer();
                o.vars.items.filter(".hovered_slide").css({
                    visibility: "hidden",
                    opacity: 0
                }).removeClass("hovered_slide");
                o.vars.sliderBlock.find(".ge_hover_slider_thumbs > li").filter(".hovered_item").removeClass("hovered_item");
                o.vars.items.eq(e).css({visibility: "visible", opacity: 1}).addClass("hovered_slide");
                o.vars.sliderBlock.find(".ge_hover_slider_thumbs > li").eq(e).addClass("hovered_item");
                ...
                e(".ge_hover_slider_thumb").bind("mouseover", function () {
                    var t = o.vars.items.filter(".hovered_slide").index(), n = e(this).parents("li").index();
                    if (t !== n) {
                        o.nextSlide(n)
                    }
                });
                e(".ge_hover_slider_thumb").bind("click", function () {
                    return false
                });
                if (o.options.pauseOnHover) {
                    o.vars.sliderBlock.bind("mouseover", function () {
                        o.vars.inPause = true
